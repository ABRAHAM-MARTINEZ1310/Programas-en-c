...
void despedida() {
    ...
    gotoxy(25, 11); printf("Proyecto elaborado por Abraham Ismael.");
    color(15);
...
Fraccion leer_fraccion() {
    ...
    color(10);
    while (1) {
        printf("Ingrese en el formato de fraccion a/b: ");
...
int menu_principal() {
    ...
    gotoxy(30, 14); printf("11. Agradecimientos");
...
int main() {
    ...
    color(12);
    printf("\nIngrese filas y columnas de la matriz B:\n");
    ...
    do {
        ...
        switch (opc) {
            ...
            case 2:
                ...
                printf("\nMatriz B:\n"); mostrar_matriz_color(B, fB, cB, 12);
                printf("Transpuesta de la matriz  B:\n"); {
            ...
            case 5:
                if (c == fB) {
                    ...
                    printf("Resultado de la multiplicacion A * B:\n"); mostrar_matriz_color(R, f, cB, 11);
                    liberar_matriz(R, f);
                } else mostrar_error_y_pausar("Columnas de A deben coincidir con filas de B.");
                break;
            case 6:
                if (f == c) {
                    printf("Determinante de la matriz A: "); imprimir_fraccion(determinante(A, f), 10); printf("\n");
                } else mostrar_error_y_pausar("La matriz A no es cuadrada.");
                if (f == cB) {
                    printf("Determinante de la matriz B: "); imprimir_fraccion(determinante(B, fB), 12); printf("\n");
