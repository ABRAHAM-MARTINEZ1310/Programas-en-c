...
const char* palabras(int opc){
    switch(opc){
        ...
        case 4:
            return "bombini gusini";
            
        case 5:
            return "brrr patatrim";
...
void elevarMatriz(int n, int matriz[n][n], int exponente, int resultado[n][n]) {
    ...
    for (int i = 0; i < exponente; i++) {
        multiplicar(n, resultado, matriz, temp);     
        copiarMatriz(n, temp, resultado);            
    }
}
...
int main(){
    ...
    printf("%s\n", "1.-Struct de estudiante");
    printf("%s\n", "2.-Struct declarativa");
    printf("%s\n", "3.-Arreglo"); 
    printf("%s\n", "4.-Arreglo 2"); 
    printf("%s\n", "5.- Struct de lectura");
    printf("%s\n", "6.-Arreglo estructuras");
    printf("%s\n", "7.-Estrutura aninada");
    printf("%s\n", "8.-Estrutura doble aninada");
    printf("%s\n", "9.-Clave valor");
    printf("%s\n", "10.-Multiplicacion de una estrutura");
    printf("%s\n", "11.- Ecuacion cuadratica");
    printf("%s\n", "12.- Ecuacion cuadratica 2"); 
    printf("%s\n", "13.-Coordenadas");
    printf("%s\n", "14.-Coordenadas V2");
    printf("%s\n", "15.-Struct de impresion");
    printf("%s\n", "16.-Sprinft");
    printf("%s\n", "17.-Union");
    printf("%s\n", "18.-Vehiculos");
    printf("%s\n", "19.-Matriz");
    ...
    printf("%s\n", "26.-Apuntador ");
    printf("%s\n", "27.-Indirecciones");
    printf("%s\n", "28.-Apuntadores operacion");
    printf("%s\n", "29.-Apuntadores constante");
    printf("%s\n", "30.-Registros");
    printf("%s\n", "31.-Funciones");
    printf("%s\n", "32.-Funcion figura");
    printf("%s\n", "33.-Funcionnumero mayor");
    printf("%s\n", "34.-Funcion numero mayor en 3 numeros");
    printf("%s\n", "35.- Funcion Suma de numero en rango");
    printf("%s\n", "36.-Funcion para determinar signo");
    printf("%s\n", "37.- Funcion de Exponenciales");
    printf("%s\n", "38.-Funcion Matriz impar");
    printf("%s\n", "39.-Funcion Intervalo par");
    printf("%s\n", "40.-Funcion de tabla de multiplica");
    printf("%s\n", "41.-Numeros que almacenenan palabras");
    printf("%s\n", "42.-Temperatura");
    printf("%s\n", "43.-F a C");
    printf("%s\n", "44.-K a F");
    printf("%s\n", "45.-C a k");
    ...
    printf("%s\n", "47.-Ecuacion funcion");
    printf("%s\n", "48.-Matriz Funcion");
    printf("%s\n", "49.-Matriz raiz cuadrada");
    printf("%s\n", "50.-Matriz por vector");
    printf("%s\n", "51.-Transpuesta");
    printf("%s\n", "52.-Funcion Multiplicacion matriz ");
    printf("%s\n", "53.-Funcion matriz por matriz en fracc");
    printf("%s\n", "54.-Matriz exponente");
    printf("%s\n", "55.-Colores");
    printf("%s\n", "56.-Gotoxy");
    printf("%s\n", "57.-Gotoxy 2");
    printf("%s\n", "58.-Gotoxy 3");
    printf("%s\n", "59.-Menu gotoxy funcional");
    printf("%s\n", "60.-Triangulo de color");
    printf("%s\n", "61.-Bandera de Mexico");
    printf("%s\n", "62.- Bandera EU");
    printf("%s\n", "63.- Cuadrado nxn");
    ...
    switch(opc){
        ...
        printf("%s\n", "1.-Struct de estudiante");
            ...
            struct Estudiante estudiante1= {"Abraham Ismael", 18, 9.4};
        ...
        printf("%s\n", "2.-Struct declarativa");
            ...
            Estudiante2 estudiante12 = {"Luis Rodriguez", 24, 9.7};
            printf("nombre: %s\n", estudiante12.nombre);
            printf("Edad: %d\n", estudiante12.edad);
        ...
        printf("\033[2J"); 
        printf("%s\n", "7.-Estrutura aninada");
            struct Persona2 persona1 = {"Juan Jose", {"Av.Reforma", 207}};
            printf("nombre: %s\n", persona1.nombre);
        ...
        case 12:{       printf("\033[2J"); 
            printf("%s\n", "12.- Ecuacion cuadratica 2"); 

            int size2; 
            printf("Ingrese la cantidad de ecuaciones: \n"); 
            scanf("%d", &size2); 
            struct Eccradratica2 arreglo2[size2]; 
            
            for(int i = 0; i < size2; i++) { 
                printf("%s"," ingrese el valor de a2:"); 
                scanf("%d", &arreglo2[i].a2);
                printf("%s"," ingrese el valor de b2:"); 
                scanf("%d", &arreglo2[i].b2); 
                printf("%s"," ingrese el valor de c2:"); 
                scanf("%d", &arreglo2[i].c2); 
            }  
        
            for (int i = 0; i < size2; i++) { 
                int d2 = (arreglo2[i].b2 * arreglo2[i].b2) - (arreglo2[i].a2 * arreglo2[i].c2); 
                if(d2 < 0) { 
                    strcpy(arreglo2[i].soluc2, "no tiene solucion"); 
                } else { 
                    float valx12 = ((-1) * arreglo2[i].b2 + sqrt(d2)) / (2 * arreglo2[i].a2); 
                    float valx22 = ((-1) * arreglo2[i].b2 - sqrt(d2)) / (2 * arreglo2[i].a2); 
                    strcpy(arreglo2[i].soluc2, "Tiene solucion"); 
                    arreglo2[i].x12 = valx12; 
                    arreglo2[i].x22 = valx22; 
                }
            }
        
            printf("\n--- Resultados ---\n"); 
            printf("%s|%s|%s|%s|%s|%s\n", "a2", "b2", "c2", "x12", "x22", "soluc2"); 
            for (int i = 0; i < size2; i++) { 
                printf("\nEcuacion [%d]:\n", i);
                printf("%d | %d | %d | %.2f | %.2f | %s \n",
                        arreglo2[i].a2,
        ...
        case 13:{       printf("\033[2J"); 
            ...
            switch(opc) { 
                case 1: 
                    ...
                    float d1 = sqrt(pow(figura.x23 - figura.x13, 2) + pow(figura.y23 - figura.y13, 2)); 
                    float d2 = sqrt(pow(figura.x3 - figura.x23, 2) + pow(figura.y3 - figura.y23, 2)); 
                    float d3 = sqrt(pow(figura.x4 - figura.x3, 2) + pow(figura.y4 - figura.y3, 2));
                    float d4 = sqrt(pow(figura.x13 - figura.x4, 2) + pow(figura.y13 - figura.y4, 2)); 
                    float perimetro = d1 + d2 + d3 + d4;
                    float area = d1 * d2;
                ...
                case 2:
                    ...
                    float d1t = sqrt(pow(figura.x23 - figura.x13, 2) + pow(figura.y23 - figura.y13, 2));
                    float d2t = sqrt(pow(figura.x3 - figura.x23, 2) + pow(figura.y3 - figura.y23, 2)); 
                    float d3t = sqrt(pow(figura.x13 - figura.x3, 2) + pow(figura.y13 - figura.y3, 2));
                    float perimetrot = d1t + d2t + d3t; 
                    float s = perimetrot / 2; 
                    float areat = sqrt(s * (s - d1t) * (s - d2t) * (s - d3t)); 
        ...
        case 14:{       printf("\033[2J");     printf("%s\n", "14.-Coordenadas V2");
            int opc; 
            printf("%s\n", "Selecciona una opcion:"); 
            printf("%s\n", "1.-cuadrado");
            printf("%s\n", "2.-triangulo");
        ...
        case 28:{printf("\033[2J"); 
            printf("%s\n", "28.-Apuntadores operacion");
            int fno, sno, *ptr, *qtr, sum, res, multi, *sumapt, *restapt, *multiapt, *diviapt;
            float divi;
    ...
    printf("%s\n", "38.-Funcion Matriz impar");
        ...
        case 45:{printf("\033[2J"); 
            printf("%s\n", "45.-C a k");
            float a;
            printf("Ingresala temperatura en C y la convertire a k\n");
            scanf("%f", &a);
            float conversion = temperatura(a);
            printf("Esta es la conversion %.2f = %.2f",a,conversion);
        }
        ...
        case 46:{printf("\033[2J"); 
            printf("%s\n", "46.-Cambio de moneda");
            float d;
            printf("Ingresa los dolares y te dire cuanto es en pesos\n");
            scanf("%f", &d);
